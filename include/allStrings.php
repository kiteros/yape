<?php
  ...
  $string['FR']['index']['inscrit'] = 'Personnes inscrites';
  $string['EN']['index']['inscrit'] = 'People who signed up';

  $string['FR']['index']['signup'] = 'Inscription';
  $string['EN']['index']['signup'] = 'Sign up';
